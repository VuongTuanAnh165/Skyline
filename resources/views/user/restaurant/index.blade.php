                    ...
                    @foreach ($categories as $category)
                        <li class="widget__categories--menu__list">
                            <label class="widget__categories--menu__label d-flex align-items-center">
                                <img class="widget__categories--menu__img" src="{{ asset('storage/' . $category->image) }}"
                                    alt="categories-img">
                    ...
                    <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input">
                                ...
                                <input class="price__filter--input__field price-min border-0"
                                    value="{{ $request->has('priceMin') ? $request->priceMin : '' }}"
                                    name="filter.v.price.gte" id="Filter-Price-GTE" type="number" placeholder="0"
                                    min="0" max="250.00">
                            </div>
                        </div>
                        ...
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input">
                                <span class="price__filter--currency">đ</span>
                                <input class="price__filter--input__field price-max border-0"
                                    value="{{ $request->has('priceMax') ? $request->priceMax : '' }}"
                                    name="filter.v.price.lte" id="Filter-Price-LTE" type="number" min="0"
    ...
    <section class="shop__section section--padding">
        <div class="container-fluid">
            ...
            <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                    ...
                    <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
                        ...
                        <div class="select shop__header--select">
                            <select class="product__view--select">
                                <option {{ $request->has('sort') && $request->sort == 1 ? 'selected' : '' }}
                                    value="1">Mới nhất</option>
                                <option {{ $request->has('sort') && $request->sort == 2 ? 'selected' : '' }}
                                    value="2">Giá tăng dần</option>
                                <option {{ $request->has('sort') && $request->sort == 3 ? 'selected' : '' }}
                                    value="3">Giá giảm dần</option>
                            </select>
                        </div>
                    </div>
                    <div class="product__view--mode__list product__view--search d-xl-block ">
                        <form id="product-redirect" class="product__view--search__form"
                            action="{{ route($name_route, ['id' => $restaurant->id]) }}">
                            <label>
                                <input class="product__view--search__input border-0" name="keyword"
                                    value="{{ $request->has('keyword') ? $request->keyword : '' }}" placeholder="Tìm kiếm"
                                    type="text">
                                ...
                                <input type="hidden" id="sort" name="sort"
                                    value="{{ $request->has('sort') ? $request->sort : 1 }}">
                            </label>
                ...
                <a href="{{ route($name_route, ['id' => $restaurant->id]) }}"
                    class="btn price__filter--btn product__showing--count">Làm mới</a>
            </div>
            <div class="row">
                            ...
                            <ul class="widget__categories--menu">
                                @foreach ($categories as $category)
                                    <li class="widget__categories--menu__list" data-category="{{ $category->id }}">
                                        <label
                                            class="widget__categories--menu__label {{ $request->has('category') && $request->category != null && $request->category == $category->id ? 'active' : '' }} d-flex align-items-center">
                                            <img class="widget__categories--menu__img"
                                                src="{{ asset('storage/' . $category->image) }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">{{ $category->name }}</span>
                                        </label>
                                    </li>
                                @endforeach
                                                        ...
                                                        <div class="product__items product__items2">
                                                                ...
                                                                <a class="product__items--link"
                                                                    ...
                                                                    @if (!empty($dish->image[1]))
                                                                        <img class="product__items--img product__secondary--img"
                                                                            src="{{ asset('storage/' . $dish->image[1]) }}"
                                                                            alt="product-img">
                                                                    @endif
                                                                </a>
                                                                @php
                                                            ...
                                                            <div
                                                                ...
                                                                <h3 class="product__items--content__title h4"><a
                                                                        href="javascript:void(0)">{{ $dish->name }}</a>
                                                                </h3>
                                                                <div class="product__items--price">
                                                                    <span
                                                                        class="current__price">{{ number_format($dish->price) }}
                                                                        VND</span>
                                                                </div>
                                                                <div
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__items--thumbnail">
                                    <a class="blog__items--link"
                                        href="{{ route($url_post, ['id' => $post->id, 'name_link' => $post->name_link]) }}"><img
                                            class="blog__items--img" src="{{ asset('storage/' . $post->image) }}"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__items--content">
                                    ...
                                    <h3 class="blog__items--title"><a
                                            href="{{ route($url_post, ['id' => $post->id, 'name_link' => $post->name_link]) }}">{{ $post->name }}</a>
                                    </h3>
                                    <p class="blog__items--desc">I{{ $post->description }}</p>
                                    <a class="blog__items--readmore"
                                        href="{{ route($url_post, ['id' => $post->id, 'name_link' => $post->name_link]) }}">Xem
                                        thêm <svg class="blog__items--readmore__icon" xmlns="http://www.w3.org/2000/svg"

...
<section class="blog__section section--padding pt-0">
    <div class="container blog__section--container">
        ...
        <div class="blog__section--inner blog__swiper--activation swiper swiper-initialized swiper-horizontal swiper-pointer-events">
            <div class="swiper-wrapper" id="swiper-wrapper-58b3170cac316cc3" aria-live="polite" style="transform: translate3d(-2000px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 370px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                ...
                <div class="swiper-slide" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="assets/img/blog/blog1.png" alt="blog-img"></a>
                        </div>
                ...
                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="assets/img/blog/blog2.png" alt="blog-img"></a>
                        </div>
                ...
                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" role="group" aria-label="3 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="assets/img/blog/blog3.png" alt="blog-img"></a>
                        </div>
                ...
                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="3" role="group" aria-label="4 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="assets/img/blog/blog1.png" alt="blog-img"></a>
                        </div>
                ...
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 4" style="width: 370px; margin-right: 30px;">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="assets/img/blog/blog1.png" alt="blog-img"></a>
                        </div>
            ...
            <div class="swiper__nav--btn swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-58b3170cac316cc3"></div>
            <div class="swiper__nav--btn swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-58b3170cac316cc3"></div>
...
@endif
@include('user.restaurant.home.script')
@stop
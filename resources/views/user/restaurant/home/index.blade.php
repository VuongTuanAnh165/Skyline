                ...
                <div class="swiper-slide">
                    <div class="blog__items">
                        <div class="blog__items--thumbnail">
                            <a class="blog__items--link" href="blog-details.html"><img class="blog__items--img" src="{{ asset('storage/'.$post->image) }}" alt="blog-img"></a>
                        </div>
                        <div class="blog__items--content">
                            ...
                            <h3 class="blog__items--title"><a href="blog-details.html">{{ $post->name }}</a></h3>
                            <p class="blog__items--desc">I{{ $post->description }}</p>
                            <a class="blog__items--readmore" href="blog-details.html">Xem thêm <svg class="blog__items--readmore__icon" xmlns="http://www.w3.org/2000/svg" width="6.2" height="6.2" viewBox="0 0 6.2 6.2">

                    ...
                    <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n28">
                        ...
                        <div class="col-lg-6 col-md-8 col-12">
                            <div class="product__banner position__relative">
                                <a class="product__banner--thumbnail display-block" href="shop.html"><img class="product__banner--thumbnail__img display-block" src="assets/img/banner/product-banner.png" alt="banner-img">
                                    <div class="product__banner--content">
                                        <h3 class="product__banner--content__title text-white">Vagetable eggplant <br>
                                            100% fresh food </h3>
                                        <p class="product__banner--content__desc text-white"> We offer a hot deal offer every festival </p>
                                        <span class="btn  product__banner--content__btn text-white"> Shop Now </span>
                                    </div>
                                </a>
                            </div>
                        </div>

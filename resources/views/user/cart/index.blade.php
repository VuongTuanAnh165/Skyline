                                                        ...
                                                        <td class="cart__table--body__list">
                                                            <div class="cart__product d-flex align-items-center">
                                                                ...
                                                                <div class="cart__thumbnail">
                                                                    <a
                                                                        href="{{ route($url_show, ['id' => $detail_order_log->dish_id, 'name_link' => $detail_order_log->name_link]) }}"><img
                                                                            class="border-radius-5"
                                                                            src="{{ asset('storage/' . $detail_order_log->dish_image) }}"
                                                                            alt="cart-product"></a>
                                                                </div>
                                                                <div class="cart__content">
                                                                    <h3 class="cart__content--title h4"><a
                                                                            href="{{ route($url_show, ['id' => $detail_order_log->dish_id, 'name_link' => $detail_order_log->name_link]) }}">{{ $detail_order_log->dish_name }}</a>
                                                                    </h3>

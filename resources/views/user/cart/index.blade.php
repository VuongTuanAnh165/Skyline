                                                ...
                                                <tr class="cart__table--body__items">
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <div class="cart__product d-flex align-items-center">
                                                            ...
                                                            <div class="cart__thumbnail">
                                                                <a href="{{ route($url_show, ['id' => $detail_order_log->dish_id, 'name_link' => $detail_order_log->name_link]) }}"><img class="border-radius-5" src="{{asset('storage/'.$detail_order_log->dish_image)}}" alt="cart-product"></a>
                                                            </div>
                                                            <div class="cart__content">
                                                                <h3 class="cart__content--title h4"><a href="{{ route($url_show, ['id' => $detail_order_log->dish_id, 'name_link' => $detail_order_log->name_link]) }}">{{ $detail_order_log->dish_name }}</a></h3>
                                                                <span class="cart__content--variant">Giá: <span class="cart__price">{{ number_format($detail_order_log->dish_price) }} VND</span></span>
                                                                <input type="hidden" class="value_price" value="{{ $detail_order_log->dish_price }}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="cart__table--body__list">
                                                        @php
                                                            $detail_item_logs = \App\Models\DetailItemLog::where('detail_order_log_id', $detail_order_log->id)->groupBy('item')->get();
                                                        @endphp
                                                            ...
                                                            @if (!empty($detail_item_log->item))
                                                                @foreach ($detail_item_log->item as $item)
                                                                    ...
                                                                    <div class="cart__price">
                                                                        <h3 class="cart__content--title h4">{{$menu->name}}: </h3>
                                                                        @if(is_array($item[1]))
                                                                            @foreach($item[1] as $value)
                                                                                ...
                                                                                @endphp
                                                                                @if($menu_item)
                                                                                    <span class="cart__content--variant cart__content">
                                                                                        <ul>
                                                                                            <li>
                                                                                                {{ $menu_item->name }}:
                                                                                                <span class="cart__price"> + {{ number_format($menu_item->add_price) }} VND</span>
                                                                                                <input type="hidden" class="value_price" value="{{ $menu_item->add_price }}">
                                                                                            </li>
                                                                                        </ul>
                                                                                    </span>
                                                                                @else
                                                                                    <span class="cart__content--variant cart__content">Không có</span>
                                                                                @endif
                                                                            @endforeach
                                                                        @else
                                                                            @php
                                                    ...
                                                    <td class="cart__table--body__list">
                                                        <div class="quantity__box">
                                                            ...
                                                            <label>
                                                                <input type="number" class="quantity__number quickview__value--number" value="{{$detail_order_log->quantity}}" min="1" data-counter />
                                                            </label>

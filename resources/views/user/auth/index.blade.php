                    ...
                    <div class="col">
                        <div class="account__login">
                            ...
                            <div class="account__login--inner">
                                ...
                                <label>
                                    <input class="account__login--input" placeholder="Mật khẩu" name="password" type="password">
                                </label>
                    ...
                    <div class="col">
                        <div class="account__login register">
                            ...
                            <div class="account__login--inner">
                                ...
                                <label>
                                    <input class="account__login--input" placeholder="Nhập lại mật khẩu" name="password_confirmation" type="password">
                                </label>

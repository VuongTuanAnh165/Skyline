                    ...
                    <div class="col">
                        <form id="login" class="account__login login" method="post" action="{{ route('user.login') }}">
                            ...
                            <div class="account__login--inner">
                                <label>
                                    <input class="account__login--input" placeholder="Email" name="email_login" type="email"
                                        autocomplete="off" value="{{ old('email_login') ? old('email_login') : '' }}">
                                    @if ($errors->first('email_login'))
                                        <div class="error error-be">{{ $errors->first('email_login') }}</div>
                                    @endif
                                </label>
                                <label>
                                    <input class="account__login--input" placeholder="Mật khẩu" name="password_login"
                                        autocomplete="new-password" type="password"
                                        value="{{ old('password_login') ? old('password_login') : '' }}">
                                    @if ($errors->first('password_login'))
                                        <div class="error error-be">{{ $errors->first('password_login') }}</div>
                                    @endif
                                </label>
                                ...
                                <p class="account__login--signup__text">Bạn chưa có tài khoản? <button>Đăng ký ngay</button>
                                </p>
                            </div>
                        </form>
                    </div>
                    <div class="col">
                        <form id="register" class="account__login register" method="post"
                            ...
                            <div class="account__login--inner">
                                <label>
                                    <input class="account__login--input" placeholder="Họ tên" name="name" type="text"
                                        autocomplete="off" value="{{ old('name') ? old('name') : '' }}">
                                    @if ($errors->first('name'))
                                        <div class="error error-be">{{ $errors->first('name') }}</div>
                                    @endif
                                </label>
                                <label>
                                    <input class="account__login--input" placeholder="Email" name="email" type="email"
                                ...
                                <label>
                                    <input class="account__login--input" placeholder="Mật khẩu" name="password"
                                        autocomplete="new-password" type="password"

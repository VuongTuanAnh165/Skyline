                    ...
                    <div class="product__details--media">
                        <div class="product__media--preview  swiper">
                            <div class="swiper-wrapper">
                                @if (!empty($dish->image))
                                    @foreach ($dish->image as $item)
                                        @if (!empty($item))
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox"
                                                       data-gallery="product-media-preview"
                                                       href="{{ asset('storage/' . $item) }}"><img
                                ...
                                @else
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                               data-gallery="product-media-preview"
                                               href="{{ asset('img/background_default.jpg') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('img/background_default.jpg') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                   href="{{ asset('img/background_default.jpg') }}"
                                                   data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg"
                                                         xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                         height="22.443"
                            ...
                            <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--nav__items">
                                                    <img class="product__media--nav__items--img"
                                                         src="{{ asset('storage/' . $item) }}" alt="product-nav-img">
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                                @else
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                 src="{{ asset('img/background_default.jpg') }}" alt="product-nav-img">
                                        </div>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="product__details--info">
                        <div>
                            ...
                            <div class="product__details--info__price mb-15">
                                <span class="current__price current__price-dish-price">{{ number_format($dish->price) }}
                                    VND</span>
                            ...
                            <p class="product__details--info__desc mb-20">
                                ...
                                @if (!empty($dish->category_home_id))
                                    @php
                                        $category_home = \App\Models\CategoryHome::select('id', 'name')
                                            ->whereIn('id', $dish->category_home_id)
                                            ->get();
                                    @endphp
                            ...
                            <div class="product__variant">
                                @foreach ($menus as $menu)
                                    ...
                                    <div class="product__variant--list mb-20">
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <ul class="variant__size d-flex {{ $required }} menu_{{ $menu->id }}"
                                                data-name="{{ $menu->name }}">
                                                @foreach ($menu_items as $menu_item)
                                                    @if ($menu_item->menu_id == $menu->id)
                                                        <li class="variant__size--list">
                                                            <input id="menu_item_{{ $menu_item->id }}"
                                                                   name="menu_{{ $menu->id }}"
                                                                   type="{{ $multiple }}"
                                ...
                                <div class="product__variant--list mb-20">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title mb-8">Chi nhánh :</legend>
                                        <ul class="variant__size d-flex branch_id required">
                                            @foreach ($branches as $branch)
                                                <li class="variant__size--list">
                                                    ...
                                                    <label class="variant__size--value red variant__size_branch"
                                                           for="branch_id">số {{ $branch->name }} ({{ $branch->address }})</label>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </fieldset>
                                ...
                                <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                    ...
                                    <input type="hidden" name="restaurant_id" class="restaurant_id"
                                           value="{{ $dish->restaurant_id }}">
                                    <input type="hidden" name="user_id" class="user_id"
                                           value="{{ Auth::guard('user')->user() ? Auth::guard('user')->user()->id : '' }}">
                            ...
                            <div class="guarantee__safe--checkout">
                                ...
                                <img class="guarantee__safe--checkout__img"
                                     src="{{ asset('template_web_user/assets/img/other/safe-checkout.png') }}"
                                     alt="Payment Image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-body split-list">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-12">
                                    <a href="{{ route($url_restaurant, ['id' => $restaurant->id]) }}"
                                       data-dismiss="modal" aria-label="Close"
                                       class="text-decoration-none d-flex border rounded p-2 bg-light align-items-center mb-2">
                                        <div class="mr-4"><img src="{{ asset('storage/' . $restaurant->logo) }}"
                                                               class="img-fluid rounded-circle" width="100px"></div>
                                        <div class="">
                                ...
                                <div class="col-md-6 col-sm-12 col-12">
                                    <div class="modal-header">
                                        <h6 class="m-0 font-weight-bold text-primary">Đánh giá: <span
                                                style="color:red; margin-left:1rem">314</span></h6>
                                        <h6 class="m-0 font-weight-bold text-primary">Tỉ lệ phản hồi: <span
                                                style="color:red; margin-left:1rem">90%</span></h6>
                                        <h6 class="m-0 font-weight-bold text-primary">Thời gian phản hổi: <span
                                                style="color:red; margin-left:1rem">trong vài giờ</span></h6>
                                    </div>
                                    <div class="modal-header">
                                        <h6 class="m-0 font-weight-bold text-primary">Người theo dõi: <span
                                                style="color:red; margin-left:1rem">314</span></h6>
                                        <h6 class="m-0 font-weight-bold text-primary">Sản phẩm: <span
                                                style="color:red; margin-left:1rem">{{ count($dishes) }}</span></h6>
                                        <h6 class="m-0 font-weight-bold text-primary">Tham gia: <span
                                                style="color:red; margin-left:1rem">{{ $restaurant->started_at }}</span>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="reviews__comment--area">
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img
                                                    src="{{ asset('template_web_user/assets/img/other/comment-thumb1.png') }}"
                                                    alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    ...
                                                    <span
                                                        class="reviews__comment--content__date">February 13, 2022</span>
                                                </div>
                                                <p class="reviews__comment--content__desc">Lorem ipsum, dolor sit amet
                                                    ...
                                                    Veniam,
                                                    rem nesciunt. Assumenda distinctio, autem error repellat eveniet
                                                    ratione
                                                    dolor facilis accusantium amet pariatur, non eius!</p>
                                            </div>
                                        </div>
                                        <div class="reviews__comment--list margin__left d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img
                                                    src="{{ asset('template_web_user/assets/img/other/comment-thumb2.png') }}"
                                                    alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                        ...
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img
                                                    src="{{ asset('template_web_user/assets/img/other/comment-thumb3.png') }}"
                                                    alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">

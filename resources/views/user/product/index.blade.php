            ...
            <ul class="widget__categories--menu">
                ...
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img" src="{{ asset('storage/'.$categoryHome->image) }}" alt="categories-img">
                ...
                <div class="product__view--mode__list product__view--search d-xl-block ">
                    <form id="product-redirect" class="product__view--search__form" action="{{ route($name_route) }}">
                        <label>
                            ...
                            <input type="hidden" id="input-categoryHome" name="categoryHome" value="{{ $request->has('categoryHome') ? $request->categoryHome : '' }}">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="shop__sidebar--widget widget__area d-none d-lg-block bg__gray--color">
                    <div class="single__widget widget__bg">
                        ...
                        <ul class="widget__categories--menu">
                            @foreach($categoryHomes as $categoryHome)
                            <li class="widget__categories--menu__list" data-categoryhome="{{ $categoryHome->id }}">
                                <label class="widget__categories--menu__label {{ ($request->has('categoryHome') && $request->categoryHome!=null && $request->categoryHome == $categoryHome->id) ? 'active' : '' }} d-flex align-items-center">
                                    <img class="widget__categories--menu__img" src="{{ asset('storage/'.$categoryHome->image) }}" alt="categories-img">
                                    <span class="widget__categories--menu__text">{{ $categoryHome->name }}</span>
                                </label>
                            </li>

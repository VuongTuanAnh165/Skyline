                        ...
                        <li class="widget__categories--menu__list">
                            <label class="widget__categories--menu__label d-flex align-items-center">
                                <img class="widget__categories--menu__img"
                                    src="{{ asset('storage/' . $categoryHome->image) }}" alt="categories-img">
                                <span class="widget__categories--menu__text">{{ $categoryHome->name }}</span>
                            </label>
                        </li>
                    @endforeach
                </ul>
                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            ...
                            <li class="breadcrumb__content--menu__items"><span>{{ $title }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="product__view--mode d-flex align-items-center">
                    ...
                    <div class="product__view--mode__list product__view--search d-xl-block ">
                        <form id="product-redirect" class="product__view--search__form"
                            action="{{ route($name_route) }}">
                            <label>
                                <input class="product__view--search__input border-0" name="keyword"
                                    value="{{ $request->has('keyword') ? $request->keyword : '' }}"
                                    placeholder="Tìm kiếm" type="text">
                                <input type="hidden" id="input-categoryHome" name="categoryHome"
                                    value="{{ $request->has('categoryHome') ? $request->categoryHome : '' }}">
                    ...
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block bg__gray--color">
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__categories--menu">
                                @foreach ($categoryHomes as $categoryHome)
                                    <li class="widget__categories--menu__list"
                                        data-categoryhome="{{ $categoryHome->id }}">
                                        <label
                                            class="widget__categories--menu__label {{ $request->has('categoryHome') && $request->categoryHome != null && $request->categoryHome == $categoryHome->id ? 'active' : '' }} d-flex align-items-center">
                                            <img class="widget__categories--menu__img"
                                                src="{{ asset('storage/' . $categoryHome->image) }}"
                                                alt="categories-img">
                                            <span class="widget__categories--menu__text">{{ $categoryHome->name }}</span>
                                        </label>
                                    </li>
                                ...
                                <div class="product__section--inner product__section--style3__inner">
                                    <div
                                        ...
                                        @foreach ($dishes as $dish)
                                            @if ($request->has('categoryHome') && $request->categoryHome != null)
                                                @if (in_array($request->categoryHome, $dish->category_home_id))
                                                    <div class="col mb-30">

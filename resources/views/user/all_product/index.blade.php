                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="" href="{{ $url_home }}">Trang
                                    chủ</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="">{{ $title }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                <div class="product__items product__items2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="product__items--price">
                                                            <span class="current__price">{{ number_format($dish->price) }}
                                                                VND</span>
                                                        </div>
                                                        <div

...
@section('title', 'Thêm mới lựa chọn' )
@section('addcss')
...
<section class="content">
    <form method="POST" action="{{ route('admin.price_list.store') }}" class="form-customer" enctype="multipart/form-data">

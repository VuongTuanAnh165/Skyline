    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.promotion.create') }}" class="m-0 btn bg-gradient-success btn-lg">{{ __('messages.admin.table.create') }}</a>
            </div>
        </div>
    </div>
</div>
@include('admin.be.promotion.table')
@stop
@section('addjs')
    ...
    @include('admin.be.promotion.script')
@stop
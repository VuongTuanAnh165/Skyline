...
@section('title', __('messages.admin.service.title') )
@section('addcss')
    <!-- DataTables -->
    ...
    @include('admin.be.partials.breadcrumbs',
        [
            'breadcrumb'=> [
                ...
                ['title' => __('messages.admin.service.title'), 'url' => '#']
            ]
        ])
@stop
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('messages.admin.service.title') }}</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.service_group.index') }}" class="m-0 btn bg-gradient-warning btn-lg">{{ __('messages.admin.service_group.title') }}</a>
                <a href="{{ route('admin.service.create') }}" class="m-0 btn bg-gradient-success btn-lg">{{ __('messages.admin.table.create') }}</a>
            </div>
        </div>
    </div>
</div>
@include('admin.be.service.table')
@stop
@section('addjs')
    ...
    @include('admin.be.service.script')
@stop
...
@section('title', __('messages.admin.service_type.edit.title') )
@section('addcss')
    <!-- Select2 -->
...
@include('admin.be.partials.breadcrumbs',
    [
        'breadcrumb'=> [
            ...
            ['title' => __('messages.admin.service_type.edit.title'), 'url' => '#']
        ]
    ])
@stop
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{  __('messages.admin.service_type.edit.title') }}</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
...
<section class="content">
    <form method="POST" action="{{ route('admin.service_type.update', ['id_service' => $service->id, 'id' => $data->id]) }}" class="form-customer" enctype="multipart/form-data">

            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('messages.admin.image.table.title') }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ __('messages.admin.image.table.type') }}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ __('messages.admin.image.type')[$data->type] }}</td>
                                    <td class="project-actions text-right">
                                        <div data-id="{{$data->id}}" data-toggle="modal" data-target="#modalFormimage" data-url="{{ route('admin.image.update', ['id' => $data->id]) }}" class="btn btn-info btn-sm dish-update btn-modal-form">

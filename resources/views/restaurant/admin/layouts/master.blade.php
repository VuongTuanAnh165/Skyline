...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('storage/'.$logo_web) }}">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('storage/'.$logo_web) }}">
    @yield('addcss')
</head>

<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('restaurant.admin.layouts.header')
        @include('restaurant.admin.layouts.aside')
        <div class="content-wrapper">
            @yield('content')
        </div>
        @include('restaurant.admin.layouts.footer')
    </div>

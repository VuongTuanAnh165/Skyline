...
@section('title', __('messages.admin.promotion.title') )
@section('addcss')
    <!-- DataTables -->
    ...
    @include('restaurant.admin.partials.breadcrumbs',
        [
            'breadcrumb'=> [
                ...
                ['title' => __('messages.admin.promotion.title'), 'url' => '#']
            ]
        ])
@stop
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('messages.admin.promotion.title') }}</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('restaurant.promotion.create') }}" class="m-0 btn bg-gradient-success btn-lg">{{ __('messages.admin.table.create') }}</a>
            </div>
        </div>
    </div>
</div>
@include('restaurant.admin.promotion.table')
@stop
@section('addjs')
    ...
    @include('restaurant.admin.promotion.script')
@stop
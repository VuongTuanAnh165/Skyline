...
@section('title', __('messages.admin.promotion.edit.title') )
@section('addcss')
...
@include('restaurant.admin.partials.breadcrumbs',
    [
        'breadcrumb'=> [
            ...
            ['title' => __('messages.admin.promotion.edit.title'), 'url' => '#']
        ]
    ])
@stop
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{  __('messages.admin.promotion.edit.title') }}</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
...
<section class="content">
    <form method="POST" action="{{ route('restaurant.promotion.update', ['id' => $data->id]) }}" class="form-customer" enctype="multipart/form-data">

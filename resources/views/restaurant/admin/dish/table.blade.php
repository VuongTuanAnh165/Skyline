                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @php
                                        $menus = \App\Models\Menu::where('dish_id', $data->id)->get();
                                    @endphp
                                    <td>
                                        @foreach($menus as $menu)
                                            <a href="{{ route('restaurant.menu.index', ['id' => $menu->id]) }}" class="btn btn-info btn-sm dish-menu">
                                                {{ $menu->name }}
                                            </a>
                                        @endforeach
                                    </td>
                                    ...
                                    <td class="project-actions text-right">
                                        <a href="javascript:void(0);" data-dish_id="{{$data->id}}" data-dish_name="{{$data->name}}" data-toggle="modal" data-target="#modalFormMenu" class="btn btn-success btn-sm show-dish-menu">

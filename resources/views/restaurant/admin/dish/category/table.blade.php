            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ $messages['category']['table']['title'] }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ $messages['category']['table']['name'] }}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        <div data-id="{{$data->id}}" data-toggle="modal" data-target="#modalFormCategory" data-url="{{ route('restaurant.category.update', ['id' => $data->id]) }}" class="btn btn-info btn-sm dish-update btn-modal-form">

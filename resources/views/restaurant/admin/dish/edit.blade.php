...
@section('title', $messages['dish']['edit']['title'] )
@section('addcss')
    <!-- summernote -->
...
@include('restaurant.admin.partials.breadcrumbs',
    [
        'breadcrumb'=> [
            ...
            ['title' => $messages['dish']['edit']['title'], 'url' => '#']
        ]
    ])
@stop
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{  $messages['dish']['edit']['title'] }}</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
...
<section class="content">
    <form method="POST" action="{{ route('restaurant.dish.update', ['id' => $data->id]) }}" class="form-customer" enctype="multipart/form-data">

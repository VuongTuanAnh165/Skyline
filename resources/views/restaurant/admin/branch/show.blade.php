    ...
    <div class="row">
            ...
            @if ($data->background)
                ...
                <div class="col-12 product-image-thumbs">
                    @foreach ($data->background as $value)
                        <div class="product-image-thumb {{ $background == $value ? 'active' : '' }}"><img
                                src="{{ asset('storage/' . $value) }}" alt="Product Image"></div>
                    @endforeach
                </div>
            @else
                <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="longitude" id="longitude"
                        value="{{ isset($data->longitude) ? $data->longitude : '' }}" class="form-control">
                    <input type="hidden" name="latitude" id="latitude"
                        value="{{ isset($data->latitude) ? $data->latitude : '' }}" class="form-control">
        ...
        <div class="col-12 col-sm-2">
            <a class="btn btn-info btn-sm float-right"
                href="{{ route('restaurant.branch.edit', ['id' => $data->id]) }}">

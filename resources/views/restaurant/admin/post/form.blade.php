                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="name">{{ __('messages.admin.post.table.name') }}</label>
                            <input type="text" id="name" name="name" placeholder="{{ __('messages.admin.post.table.name') }}" value="{{ old('name') ? old('name') : (isset($data->name) ? $data->name : '') }}" class="form-control">
                        ...
                        <div class="form-group form-logo">
                            ...
                            <div class="upload-logo">
                                <input class="up-logo" accept="image/*" type="file" id="imgInp" name="image" data-msg-accept="{{ __('validation.form.image') }}" />

...
@section('title', __('messages.admin.post.title') )
@section('addcss')
    <!-- DataTables -->
    ...
    @include('restaurant.admin.partials.breadcrumbs',
        [
            'breadcrumb'=> [
                ...
                ['title' => __('messages.admin.post.title'), 'url' => '#']
            ]
        ])
@stop
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('messages.admin.post.title') }}</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('restaurant.post.create') }}" class="m-0 btn bg-gradient-success btn-lg">{{ __('messages.admin.table.create') }}</a>
            </div>
        </div>
    </div>
</div>
@include('restaurant.admin.post.table')
@stop
@section('addjs')
    ...
    @include('restaurant.admin.post.script')
@stop
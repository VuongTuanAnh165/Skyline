@extends('restaurant.admin.auth.master')
@section('title', __('messages.admin.login.title'))
@section('addcss')
    <link rel="stylesheet" href="{{ asset('css/web_admin/auth/form.css') }}">
@stop
@section('content')
<form action="{{ route('restaurant.post.login')}}" method="POST" class="login100-form validate-form form-customer">
    {{ csrf_field() }}
...
@section('addjs')
    ...
    @endif
    @include('restaurant.admin.auth.script')
@stop